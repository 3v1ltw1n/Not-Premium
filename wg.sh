...
# Tambahan
cd /usr/bin
wget -O add-wg "https://raw.githubusercontent.com/XC0D3-X/Not-Premium/main/add/add-wg.sh"
wget -O del-wg "https://raw.githubusercontent.com/XC0D3-X/Not-Premium/main/delete/del-wg.sh"
wget -O cek-wg "https://raw.githubusercontent.com/XC0D3-X/Not-Premium/main/check/cek-wg.sh"
wget -O renew-wg "https://raw.githubusercontent.com/XC0D3-X/Not-Premium/main/renew/renew-wg.sh"
chmod +x add-wg
chmod +x del-wg
chmod +x cek-wg
chmod +x renew-wg
