...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/XC0D3-X/Not-Premium/main/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/XC0D3-X/Not-Premium/main/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/add-ssr https://raw.githubusercontent.com/XC0D3-X/Not-Premium/main/add/add-ssr.sh && chmod +x /usr/bin/add-ssr
wget -O /usr/bin/del-ssr https://raw.githubusercontent.com/XC0D3-X/Not-Premium/main/delete/del-ssr.sh && chmod +x /usr/bin/del-ssr
